...
public class StarsWorker extends UniversalActor  {
	public static void main(String args[]) {
		...
		StarsWorker instance = (StarsWorker)new StarsWorker(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new StarsWorker(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return StarsWorker.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new StarsWorker(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return StarsWorker.getReferenceByLocation(new UAL(ual)); }
	public StarsWorker(boolean o, UAN __uan)	{ super(false,__uan); }
	public StarsWorker(boolean o, UAL __ual)	{ super(false,__ual); }
	public StarsWorker(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public StarsWorker(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public StarsWorker(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public StarsWorker()		{  }
	public StarsWorker(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "rpiwcl.cos.test.salsa.stars.StarsWorker", sourceRef);
			  }
	...
	public UniversalActor construct (int id, Point3d[] stars, int numStars, Vector tasks) {
		Object[] __arguments = { new Integer(id), stars, new Integer(numStars), tasks };
	...
	public class State extends UniversalActor .State {
		public StarsWorker self;
		public void updateSelf(ActorReference actorReference) {
			((StarsWorker)actorReference).setUAL(getUAL());
			((StarsWorker)actorReference).setUAN(getUAN());
			self = new StarsWorker(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "rpiwcl.cos.test.salsa.stars.StarsWorker$State" );
		...
		Vector tasks;
		Result result;
		void construct(int id, Point3d[] stars, int numStars, Vector tasks){
			this.id = id;
			this.stars = stars;
