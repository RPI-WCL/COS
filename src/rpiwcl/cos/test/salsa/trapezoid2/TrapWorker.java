...
public class TrapWorker extends UniversalActor  {
	...
	public TrapWorker(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "rpiwcl.cos.test.salsa.trapezoid2.TrapWorker", sourceRef);
			  }
	...
	public UniversalActor construct (int id, String farmerUAN) {
		Object[] __arguments = { new Integer(id), farmerUAN };
	...
	public class State extends UniversalActor .State {
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "rpiwcl.cos.test.salsa.trapezoid2.TrapWorker$State" );
		...
		double integral;
		int burstSize;
		void construct(int id, String farmerUAN){
			this.id = id;
		...
		public int reportProgress(int iter) {
		...
		public int addBurst(int iter) {
			int i;
			for (i = iter; (i<iter+burstSize)&&(i<numIter); i++)integral += trap.add(i);
			return i;
		}
		public double addIter(int iter) {
			if (iter==numIter) {			return integral;
}			{
				...
				// addBurst(iter)
				{
					...
					Message message = new Message( self, self, "addBurst", _arguments, null, token_2_0 );
					__messages.add( message );
				}
				// reportProgress(token)
				{
					Object _arguments[] = { token_2_0 };
					Message message = new Message( self, self, "reportProgress", _arguments, token_2_0, token_2_1 );
					__messages.add( message );
				}
				// addIter(token)
				{
					Object _arguments[] = { token_2_1 };
					Message message = new Message( self, self, "addIter", _arguments, token_2_1, currentMessage.getContinuationToken() );
					__messages.add( message );
				}
		...
		public Double trap(double local_a, double local_b, int local_n, double h) {
			...
			integral = trap.startIntegral();
			{
				...
				// addIter(1)
				{
					...
					Message message = new Message( self, self, "addIter", _arguments, null, token_2_0 );
					__messages.add( message );
				}
		...
		public Double convertToDouble(double d) {
			System.out.println("Worker "+id+" finished (elapsed time = "+((double)(System.currentTimeMillis()-startTime)/1000)+"s)");
			return (new Double(d));
		}
	}
}