...
public class Trap extends UniversalActor  {
	...
	public Trap(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "rpiwcl.cos.test.salsa.trapezoid.Trap", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "rpiwcl.cos.test.salsa.trapezoid.Trap$State" );
		...
		public void act(String args[]) {
			...
			this.cosPort = Integer.parseInt(args[6]);
			{
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, self, "startTrap", _arguments, null, null );
		...
		public void startTrap() {
			...
			{
				// farmer<-submitJob(a, b, n, numWorkers, nameServer, theaters, cosIpAddr, cosPort, "Trap")
				{
					Object _arguments[] = { a, b, n, numWorkers, nameServer, theaters, cosIpAddr, cosPort, "Trap" };
