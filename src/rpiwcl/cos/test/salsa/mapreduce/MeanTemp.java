...
public class MeanTemp extends UniversalActor  {
	public static void main(String args[]) {
		...
		MeanTemp instance = (MeanTemp)new MeanTemp(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new MeanTemp(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return MeanTemp.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new MeanTemp(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return MeanTemp.getReferenceByLocation(new UAL(ual)); }
	public MeanTemp(boolean o, UAN __uan)	{ super(false,__uan); }
	public MeanTemp(boolean o, UAL __ual)	{ super(false,__ual); }
	public MeanTemp(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public MeanTemp(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public MeanTemp(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public MeanTemp()		{  }
	public MeanTemp(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "rpiwcl.cos.test.salsa.mapreduce.MeanTemp", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public MeanTemp self;
		public void updateSelf(ActorReference actorReference) {
			((MeanTemp)actorReference).setUAL(getUAL());
			((MeanTemp)actorReference).setUAN(getUAN());
			self = new MeanTemp(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "rpiwcl.cos.test.salsa.mapreduce.MeanTemp$State" );
		...
		public void act(String args[]) {
			if (args.length<6) {{
				...
				System.err.println("Usage: java MeanTemp <#workers> <input file> <output file> <theaters file> <CosIpAddr> <CosPort>");
				return;
			}
			...
			this.cosIpAddr = args[4];
			this.cosPort = Integer.parseInt(args[5]);
			{
				// startMapReduce()
				{
					Object _arguments[] = {  };
		...
		public void startMapReduce() {
			MapReduce mapReduce = ((MapReduce)new MapReduce(new UAN("uan://"+nameServer+"/meantemp"), null,this).construct());
			{
				// mapReduce<-submitJob(new MeanTempMapper(), new MeanTempCombiner(), new MeanTempReducer(), numWorkers, inputFile, outputFile, nameServer, theaters, cosIpAddr, cosPort, "MeanTemp")
				{
					Object _arguments[] = { new MeanTempMapper(), new MeanTempCombiner(), new MeanTempReducer(), numWorkers, inputFile, outputFile, nameServer, theaters, cosIpAddr, cosPort, "MeanTemp" };
