...
public class MeanTemp extends UniversalActor  {
	...
	public MeanTemp(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "salsa.examples.mapreduce.MeanTemp", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "salsa.examples.mapreduce.MeanTemp$State" );
		...
		public void startMapReduce() {
			...
			{
				// mapReduce<-submitJob(new MeanTempMapper(), new MeanTempCombiner(), new MeanTempReducer(), numWorkers, inputFile, outputFile, nameServer, theaters)
				{
					Object _arguments[] = { new MeanTempMapper(), new MeanTempCombiner(), new MeanTempReducer(), numWorkers, inputFile, outputFile, nameServer, theaters };
