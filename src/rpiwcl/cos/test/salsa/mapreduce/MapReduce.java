...
public class MapReduce extends UniversalActor  {
	...
	public MapReduce(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "rpiwcl.cos.test.salsa.mapreduce.MapReduce", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "rpiwcl.cos.test.salsa.mapreduce.MapReduce$State" );
		...
		String appName;
		CosInterface cosIf;
		public void submitJob(Mapper mapper, Reducer combiner, Reducer reducer, int numWorkers, String inputFile, String outputFile, String nameServer, Vector theaters, String cosIpAddr, int cosPort, String appName) {
			this.mapper = mapper;
