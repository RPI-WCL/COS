...
public class Leave extends UniversalActor  {
	public static void main(String args[]) {
		...
		Leave instance = (Leave)new Leave(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Leave(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Leave.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Leave(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Leave.getReferenceByLocation(new UAL(ual)); }
	public Leave(boolean o, UAN __uan)	{ super(false,__uan); }
	public Leave(boolean o, UAL __ual)	{ super(false,__ual); }
	public Leave(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Leave(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Leave(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Leave()		{  }
	public Leave(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "src.resources.Leave", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Leave)actorReference).setUAL(getUAL());
			((Leave)actorReference).setUAN(getUAN());
			self = new Leave(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "src.resources.Leave$State" );
		...
		public void act(String[] arguments) {
			if (arguments.length<1) {{
					...
					if (ual.getIdentifier().equals("/io/protocolActor")) {{
						{
							...
							{
								Object _arguments[] = {  };
								Message message = new Message( self, new UniversalActor(ual), "leaveComputation", _arguments, null, token_5_0 );
								__messages.add( message );
							}
							// standardOutput<-println("Left computation: "+ual.toString())
							{
								Object _arguments[] = { "Left computation: "+ual.toString() };
								Message message = new Message( self, standardOutput, "println", _arguments, token_5_0, token_2_0 );
								__messages.add( message );
							}
						}
					}
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, self, "completed", _arguments, token_2_1, null );
					__messages.add( message );
				}
			}
		}
