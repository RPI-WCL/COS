...
public class Join extends UniversalActor  {
	public static void main(String args[]) {
		...
		Join instance = (Join)new Join(uan, ual,null).construct();
	...
	public Join(boolean o, UAN __uan)	{ super(false,__uan); }
	public Join(boolean o, UAL __ual)	{ super(false,__ual); }
	public Join(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Join(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Join(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Join()		{  }
	public Join(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "src.resources.Join", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Join)actorReference).setUAL(getUAL());
			((Join)actorReference).setUAN(getUAN());
			self = new Join(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
					...
					if (ual.getIdentifier().equals("/io/protocolActor")) {{
						{
							...
							// new UniversalActor(ual)<-joinComputation(peerServer)
							{
								...
								Message message = new Message( self, new UniversalActor(ual), "joinComputation", _arguments, null, token_5_0 );
