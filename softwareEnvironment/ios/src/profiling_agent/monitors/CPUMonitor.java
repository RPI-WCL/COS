...
public class CPUMonitor extends UniversalActor  {
	public static void main(String args[]) {
		...
		CPUMonitor instance = (CPUMonitor)new CPUMonitor(uan, ual,null).construct();
	...
	public CPUMonitor(boolean o, UAN __uan)	{ super(false,__uan); }
	public CPUMonitor(boolean o, UAL __ual)	{ super(false,__ual); }
	public CPUMonitor(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public CPUMonitor(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public CPUMonitor(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public CPUMonitor()		{  }
	public CPUMonitor(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "src.profiling_agent.monitors.CPUMonitor", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((CPUMonitor)actorReference).setUAL(getUAL());
			((CPUMonitor)actorReference).setUAN(getUAN());
			self = new CPUMonitor(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public void construct(int delay_ms, long calculations){
			...
			flops = (double)calculations/((double)executionTime/1000.0);
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, self, "recalculateFLOPS", _arguments, null, null );
