...
public class AutonomousActor extends UniversalActor  {
	public static void main(String args[]) {
		...
		AutonomousActor instance = (AutonomousActor)new AutonomousActor(uan, ual,null).construct();
	...
	public AutonomousActor(boolean o, UAN __uan)	{ super(false,__uan); }
	public AutonomousActor(boolean o, UAL __ual)	{ super(false,__ual); }
	public AutonomousActor(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public AutonomousActor(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public AutonomousActor(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public AutonomousActor()		{  }
	public AutonomousActor(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "src.language.AutonomousActor", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((AutonomousActor)actorReference).setUAL(getUAL());
			((AutonomousActor)actorReference).setUAN(getUAN());
			self = new AutonomousActor(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
