...
public class ATSProtocolActor extends UniversalActor  implements ActorService {
	...
	public ATSProtocolActor(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null,null); }
	public ATSProtocolActor(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual,null); }
	public ATSProtocolActor(UniversalActor.State sourceActor)		{ this(null, null,null);  }
	public ATSProtocolActor()		{  }
	public ATSProtocolActor(UAN __uan, UAL __ual,Object sourceActor) {
		if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			createRemotely(__uan, __ual, "src.protocol_agent.ATSProtocolActor");
		} else {
