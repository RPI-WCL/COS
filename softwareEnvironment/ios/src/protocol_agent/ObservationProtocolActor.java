...
public class ObservationProtocolActor extends UniversalActor  implements ActorService {
	public static void main(String args[]) {
		...
		ObservationProtocolActor instance = (ObservationProtocolActor)new ObservationProtocolActor(uan, ual,null).construct();
		{
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new ObservationProtocolActor(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return ObservationProtocolActor.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new ObservationProtocolActor(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return ObservationProtocolActor.getReferenceByLocation(new UAL(ual)); }
	public ObservationProtocolActor(boolean o, UAN __uan)	{ super(false,__uan); }
	public ObservationProtocolActor(boolean o, UAL __ual)	{ super(false,__ual); }

	public ObservationProtocolActor(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null,null); }
	public ObservationProtocolActor(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual,null); }
	public ObservationProtocolActor(UniversalActor.State sourceActor)		{ this(null, null,null);  }
	public ObservationProtocolActor()		{  }
	public ObservationProtocolActor(UAN __uan, UAL __ual,Object sourceActor) {
		if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			createRemotely(__uan, __ual, "src.protocol_agent.ObservationProtocolActor");
		} else {
	...
	public class State extends UniversalActor .State implements salsa.resources.ActorServiceState {
		public ObservationProtocolActor self;
		public void updateSelf(ActorReference actorReference) {
			((ObservationProtocolActor)actorReference).setUAL(getUAL());
			((ObservationProtocolActor)actorReference).setUAN(getUAN());
			self = new ObservationProtocolActor(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.muteGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "src.protocol_agent.ObservationProtocolActor$State" );
			...
			if (connection!=null) {{
				try {
					...
					if (ual.getIdentifier().equals("/io/peerServer")) {{
						...
						{
							// joinComputation((ObservationProtocolActor)ObservationProtocolActor.getReferenceByLocation(ual))
							{
								Object _arguments[] = { (ObservationProtocolActor)ObservationProtocolActor.getReferenceByLocation(ual) };
								Message message = new Message( self, self, "joinComputation", _arguments, null, null );
								__messages.add( message );
							}
						}
		...
		public String gather_observation() {
			return profilingAgent.gather_observation(((ObservationProtocolActor)self));
		}
		public void reset_profiling_agent() {
			profilingAgent.reset_all();
		}
		...
		public void propagateSteal(ObservationProtocolActor source, double processing, Vector actorsAtSource, int timeToLive) {
		...
		public void steal(ObservationProtocolActor source, double processing, Vector actorsAtSource, int timeToLive) {
		...
		public void resolveSteal(ActorReference candidate, ObservationProtocolActor source, double processing, Vector actorsAtSource, int timeToLive) {
			if (candidate==null) {{
				{
		...
		public void joinComputation(ObservationProtocolActor neighbor) {
			profilingAgent.setComputing(true);
		...
		public void leaveRequest(ObservationProtocolActor requester) {
		...
		public void notConnected(ObservationProtocolActor neighbor) {
		...
		public void getActor(ObservationProtocolActor requester) {
