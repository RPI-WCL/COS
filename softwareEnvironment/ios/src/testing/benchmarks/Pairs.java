...
public class Pairs extends UniversalActor  {
	public static void main(String args[]) {
		...
		Pairs instance = (Pairs)new Pairs(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Pairs(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Pairs.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Pairs(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Pairs.getReferenceByLocation(new UAL(ual)); }
	public Pairs(boolean o, UAN __uan)	{ super(false,__uan); }
	public Pairs(boolean o, UAL __ual)	{ super(false,__ual); }
	public Pairs(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Pairs(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Pairs(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Pairs()		{  }
	public Pairs(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "src.testing.benchmarks.Pairs", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Pairs)actorReference).setUAL(getUAL());
			((Pairs)actorReference).setUAN(getUAN());
			self = new Pairs(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "src.testing.benchmarks.Pairs$State" );
		...
		public void act(String[] arguments) {
			...
			try {
				if (arguments.length!=5) {{
					...
					System.err.println("\tjava io.testing.benchmarks.Sparse <naming/theater information file> "+"<nodes> <messageSendingDelay(ms)> <messageSize(bytes)> <processingTime(ms)>");
					System.exit(0);
				}
			...
			Token synchToken = new Token("synchToken");
			{
				...
				// standardOutput<-println("Creating a paired actor graph with: ")
				{
					Object _arguments[] = { "Creating a paired actor graph with: " };
					Message message = new Message( self, standardOutput, "println", _arguments, null, token_2_0 );
					__messages.add( message );
				}
				// standardOutput<-println("\tnodes in paired actor graph: "+size)
				{
					Object _arguments[] = { "\tnodes in paired actor graph: "+size };
				...
				// token synchToken = standardOutput<-println("Loading actor graph randomly on theater(s): ")
				{
					...
					Message message = new Message( self, standardOutput, "println", _arguments, token_2_7, synchToken );
					__messages.add( message );
				}
			}
				...
				for (int i = 0; i<size; i += 2){
					{
						...
						// nodes[i]<-addReference(nodes[i+1])
						{
							Object _arguments[] = { nodes[i+1] };
							Message message = new Message( self, nodes[i], "addReference", _arguments, token_2_0, token_4_0 );
							__messages.add( message );
						}
						// standardOutput<-println("\tGenerated link from node_"+i+" to node_"+(i+1))
						{
							Object _arguments[] = { "\tGenerated link from node_"+i+" to node_"+(i+1) };
							Message message = new Message( self, standardOutput, "println", _arguments, token_4_0, token_2_1 );
							__messages.add( message );
						}
					}
				}
