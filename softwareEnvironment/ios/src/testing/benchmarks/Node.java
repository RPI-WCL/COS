	...
	public Node(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "src.testing.benchmarks.Node", sourceRef);
			  }
	...
	public class State extends AutonomousActor.State {
		...
		public void do_stuff(Node source, byte[] data) {
			...
			}
			{
				// source<-do_stuff(((Node)self), new byte[messageSize])
				{
					...
					Message message = new Message( self, source, "do_stuff", _arguments, null, null );
		...
		public void startSending() {
			if (references.size()==0) {			{
				...
				{
					Object _arguments[] = { ((Node)self), new byte[messageSize] };
					Message message = new Message( self, ((Node)self), "do_stuff", _arguments, null, null );
					__messages.add( message );
				}
			}
}			for (int i = 0; i<references.size(); i++){
				{
					...
					{
						Object _arguments[] = { ((Node)self), new byte[messageSize] };
						Message message = new Message( self, references.get(i), "do_stuff", _arguments, null, null );
						__messages.add( message );
					}
				}
			}
