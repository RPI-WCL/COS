...
public class Ring extends UniversalActor  {
	public static void main(String args[]) {
		...
		Ring instance = (Ring)new Ring(uan, ual,null).construct();
	...
	public Ring(boolean o, UAN __uan)	{ super(false,__uan); }
	public Ring(boolean o, UAL __ual)	{ super(false,__ual); }
	public Ring(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Ring(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Ring(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Ring()		{  }
	public Ring(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "src.testing.reachability.Ring", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Ring)actorReference).setUAL(getUAL());
			((Ring)actorReference).setUAN(getUAN());
			self = new Ring(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
