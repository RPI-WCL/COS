	...
	public Heat(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "src.testing.heat.Heat", sourceRef);
			  }
...
continue;						}
		...
		public void doWork2(String[] theaters) {
			...
			if (observationUAN!=null) {{
				ObservationCollector observationCollector = ((ObservationCollector)new ObservationCollector(new UAN(observationUAN), new UAL(observationUAL),this).construct(30000, 20));
				{
					Token token_3_0 = new Token();
					// join block
					...
					for (int i = 0; i<workers.length; i++){
						{
							// observationCollector<-register_actor(workers[i])
							{
								...
								Message message = new Message( self, observationCollector, "register_actor", _arguments, null, token_3_0 );
								__messages.add( message );
							}
						}
					...
					for (int i = 0; i<theaters.length; i++){
						{
							// observationCollector<-register_location(theaters[i])
							{
								...
								Message message = new Message( self, observationCollector, "register_location", _arguments, null, token_3_0 );
								__messages.add( message );
							}
						}
					...
					{
						Object _arguments[] = {  };
						Message message = new Message( self, observationCollector, "initiate_collection", _arguments, token_3_0, null );
