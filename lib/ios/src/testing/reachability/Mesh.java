...
public class Mesh extends UniversalActor  {
	public static void main(String args[]) {
		...
		Mesh instance = (Mesh)new Mesh(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Mesh(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Mesh.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Mesh(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Mesh.getReferenceByLocation(new UAL(ual)); }
	public Mesh(boolean o, UAN __uan)	{ super(false,__uan); }
	public Mesh(boolean o, UAL __ual)	{ super(false,__ual); }
	public Mesh(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Mesh(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Mesh(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Mesh()		{  }
	public Mesh(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "src.testing.reachability.Mesh", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Mesh)actorReference).setUAL(getUAL());
			((Mesh)actorReference).setUAN(getUAN());
			self = new Mesh(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "src.testing.reachability.Mesh$State" );
		...
		public void act(String[] arguments) {
			...
			Token synchToken = new Token("synchToken");
			{
				...
				{
					Object _arguments[] = { "Connecting the following theaters in a mesh." };
