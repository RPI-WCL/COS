...
public class Full extends UniversalActor  {
	public static void main(String args[]) {
		...
		Full instance = (Full)new Full(uan, ual,null).construct();
	...
	public Full(boolean o, UAN __uan)	{ super(false,__uan); }
	public Full(boolean o, UAL __ual)	{ super(false,__ual); }
	public Full(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Full(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Full(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Full()		{  }
	public Full(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "src.testing.reachability.Full", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Full)actorReference).setUAL(getUAL());
			((Full)actorReference).setUAN(getUAN());
			self = new Full(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
						...
						if (j!=i) {{
							...
							ATSProtocolActor protocolActor2 = (ATSProtocolActor)ATSProtocolActor.getReferenceByLocation("rmsp://"+theaterName2+"/io/protocolActor");
							{
								...
								// protocolActor1<-addPeer(protocolActor2)
								{
									...
									Message message = new Message( self, protocolActor1, "addPeer", _arguments, token_2_1, token_6_0 );
									__messages.add( message );
								}
