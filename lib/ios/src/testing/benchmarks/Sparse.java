	...
	public Sparse(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "src.testing.benchmarks.Sparse", sourceRef);
			  }
		...
		public void act(String[] arguments) {
			...
			Token synchToken = new Token("synchToken");
			{
				...
				// token synchToken = standardOutput<-println("Loading actor graph randomly on theater(s): ")
				{
					...
					Message message = new Message( self, standardOutput, "println", _arguments, token_2_8, synchToken );
					__messages.add( message );
				}
			}
				...
				for (int i = 0; i<edges; i++){
					...
					int target = (int)(java.lang.Math.random()*size);
					{
						...
						// nodes[source]<-addReference(nodes[target])
						{
							...
							Message message = new Message( self, nodes[source], "addReference", _arguments, token_2_0, token_4_0 );
							__messages.add( message );
						}
