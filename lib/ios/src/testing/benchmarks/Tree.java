	...
	public Tree(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "src.testing.benchmarks.Tree", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void act(String[] arguments) {
			...
			if (depth==0) {{
				...
				size = (int)java.lang.Math.round(java.lang.Math.pow(width, depth-1))+(int)java.lang.Math.round((java.lang.Math.pow(width, depth-1)-1))/(width-1);
			}
}}			Token synchToken = new Token("synchToken");
			{
				...
				{
					Object _arguments[] = { "Creating a tree actor graph with: " };
				...
				{
					Object _arguments[] = { "\tnodes in tree actor graph: "+size };
				...
				{
					Object _arguments[] = { "\twidth in tree actor graph: "+width };
				...
				{
					Object _arguments[] = { "\tdepth in tree actor graph: "+depth };
				...
				// token synchToken = standardOutput<-println("Loading actor graph randomly on theater(s): ")
				{
					...
					Message message = new Message( self, standardOutput, "println", _arguments, token_2_9, synchToken );
					__messages.add( message );
				}
			}
						...
						if (((i*width)+j+1)<size) {{
							{
								...
								{
									Object _arguments[] = { nodes[(i*width)+j+1] };
									Message message = new Message( self, nodes[i], "addReference", _arguments, token_2_0, token_6_0 );
									__messages.add( message );
								}
								// standardOutput<-println("\tGenerated link from node_"+i+" to node_ "+((i*width)+j+1))
								{
									Object _arguments[] = { "\tGenerated link from node_"+i+" to node_ "+((i*width)+j+1) };
