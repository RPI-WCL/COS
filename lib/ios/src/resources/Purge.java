...
public class Purge extends UniversalActor  {
	public static void main(String args[]) {
		...
		Purge instance = (Purge)new Purge(uan, ual,null).construct();
	...
	public Purge(boolean o, UAN __uan)	{ super(false,__uan); }
	public Purge(boolean o, UAL __ual)	{ super(false,__ual); }
	public Purge(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Purge(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Purge(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Purge()		{  }
	public Purge(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "src.resources.Purge", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Purge)actorReference).setUAL(getUAL());
			((Purge)actorReference).setUAN(getUAN());
			self = new Purge(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
					...
					if (ual.getIdentifier().equals("/io/peerServer")) {{
						{
							...
							{
								Object _arguments[] = {  };
								Message message = new Message( self, new UniversalActor(ual), "purgeAll", _arguments, null, token_5_0 );
...
}					else {if (ual.getIdentifier().equals("/io/protocolActor")) {{
						{
							...
							{
								Object _arguments[] = {  };
								Message message = new Message( self, new UniversalActor(ual), "purge", _arguments, null, token_5_0 );
								__messages.add( message );
							}
