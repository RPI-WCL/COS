...
public class Status extends UniversalActor  {
	public static void main(String args[]) {
		...
		Status instance = (Status)new Status(uan, ual,null).construct();
	...
	public Status(boolean o, UAN __uan)	{ super(false,__uan); }
	public Status(boolean o, UAL __ual)	{ super(false,__ual); }
	public Status(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Status(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Status(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Status()		{  }
	public Status(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "src.resources.Status", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Status)actorReference).setUAL(getUAL());
			((Status)actorReference).setUAN(getUAN());
			self = new Status(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public void act(String[] arguments) {
			if (arguments.length==0) {{
					...
					if (ual.getIdentifier().equals("/io/peerServer")) {{
						{
							...
							{
								Object _arguments[] = {  };
								Message message = new Message( self, new UniversalActor(ual), "statusAll", _arguments, null, token_5_0 );
...
}					else {if (ual.getIdentifier().equals("/io/protocolActor")) {{
						{
							...
							{
								Object _arguments[] = {  };
								Message message = new Message( self, new UniversalActor(ual), "status", _arguments, null, token_5_0 );
								__messages.add( message );
							}
							// standardOutput<-println(token)
							{
				...
				{
					Object _arguments[] = {  };
					Message message = new Message( self, self, "completed", _arguments, token_2_0, null );
					__messages.add( message );
				}
			}
		}
