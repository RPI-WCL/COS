...
public class PeerServer extends UniversalActor  {
	public static void main(String args[]) {
		...
		PeerServer instance = (PeerServer)new PeerServer(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new PeerServer(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return PeerServer.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new PeerServer(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return PeerServer.getReferenceByLocation(new UAL(ual)); }
	public PeerServer(boolean o, UAN __uan)	{ super(false,__uan); }
	public PeerServer(boolean o, UAL __ual)	{ super(false,__ual); }
	public PeerServer(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public PeerServer(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public PeerServer(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public PeerServer()		{  }
	public PeerServer(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "src.resources.PeerServer", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((PeerServer)actorReference).setUAL(getUAL());
			((PeerServer)actorReference).setUAN(getUAN());
			self = new PeerServer(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "src.resources.PeerServer$State" );
		...
		public void act(String[] arguments) {
			{
				...
				{
					Object _arguments[] = { "PeerServer listening at UAL: "+getUAL() };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
		}
		public void remove(ActorReference peer) {
			{
				// standardOutput<-println("\tRemoving from registry: "+peer.getUAL().toString())
				{
					Object _arguments[] = { "\tRemoving from registry: "+peer.getUAL().toString() };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
		...
		public void register(ActorReference peer) {
			{
				// standardOutput<-println("\tAdding to registry: "+peer.getUAL().toString())
				{
					Object _arguments[] = { "\tAdding to registry: "+peer.getUAL().toString() };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
		...
		public Vector getPeers(int maxPeers) {
			{
				// standardOutput<-println("\tReceived request for "+maxPeers+" actors.")
				{
					Object _arguments[] = { "\tReceived request for "+maxPeers+" actors." };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
		...
		public String purgeAll() {
			{
				...
				{
					Object _arguments[] = { "\tPurging the entire computation." };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
			{
				...
				if (peers.size()==0) {				return "No connected theaters.\n";
					...
					ActorReference target = (ActorReference)peers.get(i);
					{
						...
						{
							Object _arguments[] = {  };
							Message message = new Message( self, target, "purge", _arguments, null, token_4_0 );
							__messages.add( message );
						}
						// standardOutput<-println("\t\tPurged: "+target.getUAL().toString())
						{
							Object _arguments[] = { "\t\tPurged: "+target.getUAL().toString() };
							Message message = new Message( self, standardOutput, "println", _arguments, token_4_0, token_2_0 );
							__messages.add( message );
						}
					}
				}
				...
				// combine(token)
				{
					...
					Message message = new Message( self, self, "combine", _arguments, token_2_0, currentMessage.getContinuationToken() );
					__messages.add( message );
				}
		...
		public String statusAll() {
			{
				...
				if (peers.size()==0) {				return "No connected theaters.\n";
					...
					ActorReference target = (ActorReference)peers.get(i);
					{
						...
						{
							Object _arguments[] = {  };
							Message message = new Message( self, target, "status", _arguments, null, token_2_0 );
							__messages.add( message );
						}
					}
				}
		...
		public String combine(Object[] results) {
			String statusAll = "";
